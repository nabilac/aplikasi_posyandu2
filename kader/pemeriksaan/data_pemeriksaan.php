      ...
      <div class="container">
        ...
        <div class="card">
                <div class="card-header">
                    <strong class="card-title">Data Pemeriksaan</strong>
                </div>
                 <br>
                <form action="data_pemeriksaan.php" method="get">
                  <label>&nbsp;&nbsp;&nbsp;&nbsp;Cari :</label>
                    ...
                    <tbody>
                     <?php 
                      ...
                      <tr>
                       ...
                       <td><a href='pemeriksaan_per_anak.php?id_anak=<?php echo $r['id_anak'];?>'><input type="button" class="btn btn-outline-primary" value="Penimbangan"></a>
                      </tr>
                       <?php
                      }
                      ?>
