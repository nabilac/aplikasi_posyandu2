          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <?php
                $syarat=$_GET['id_anak'];
                $tanggal_pemeriksaan = mysql_query("SELECT tanggal_pemeriksaan FROM pemeriksaan WHERE id_anak='$syarat'");
                $berat_badan = mysql_query("SELECT berat_badan FROM pemeriksaan WHERE id_anak='$syarat'");
                ?>
